...
$(function(){
	...
	if(ZnowTime >= 1414771200000 && ZnowTime<=1416239999000){
		$('.index_rfloat').html('<a href="/html/activity/1414059494.html" target="_blank"><img src="http://p.sfbest.com/gold/images/20141113/20141113111801929.jpg"></a><div class="J_rclose">关闭</div>');
		$('.index_rfloat').show();
	}
